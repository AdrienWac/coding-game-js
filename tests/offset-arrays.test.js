...
describe(`Create object of array expressions`, () => {
    ...
    test(`Expression with one element`, () => {

        const arrayExpressions = ['B[-3..-3] = 1547'];
    ...
    test(`Expression with complex elements`, () => {

        const arrayExpressions = ['C[-3871032..-3871030] = 307 695 53', 'B[-3..-3] = 1547'];

        const objetOfArrayDefinitions = {
            C: { '-3871032': 307, '-3871031': 695, '-3871030': 53 },
            B: { '-3': 1547 }
        };
    ...
    test(`Multiple Expressions`, () => {
        ...
        const arrayExpressions = ['C[-3871032..-3871030] = 307 695 53'];
...
describe.each(datasProvider)(`Find number at indice 'i' for given array`, (data) => {
    ...
    test(`${data.message}`, () => {
        ...
        const numberFound = game.findNumberOfAnArray(data.input.arrayExpressions, data.input.finalExpression);

        expect(numberFound).toBe(data.output);
...
function formatInput(data) {
    ...
    [dataInputNewObject.number, ...dataInputNewObject.arrayExpressions] = data.input.split("\n").map(value => value.trim());

    dataInputNewObject.finalExpression = dataInputNewObject.arrayExpressions.pop();
